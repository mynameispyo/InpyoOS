...
;      - 0087h = Flag for os_file_selector input
;      - 0088h = Maximum number of characters that os_input_string can input
...
os_call_vectors:
	...
	jmp mouselib_remove_driver	; 817Dh
